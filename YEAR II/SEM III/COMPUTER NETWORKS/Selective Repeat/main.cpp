...
class selectiveReapeat : public protocol
{
    public:
        string buf;
        bool flag, divData;
...
void selectiveReapeat::receiver()
{
    printf("\n\nReceiver\n========");
    //if(event == wait)
    //{
...
int main()
{
    ...
    selectiveReapeat *ob = new selectiveReapeat(string(temp));
    ob->sender();
